...
public class Bank_Account {
		...
		//withdraws a double from the bank account balance, throws exception if amount is
		...
		public double withdraw(double amount) {
			...
			if(amount > this.balance) {
				throw new IllegalArgumentException("You cannot withdrawl more money than you currently have");
			}
